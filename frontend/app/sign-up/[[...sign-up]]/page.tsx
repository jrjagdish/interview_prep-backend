  ...
  return (
    <div className="min-h-screen bg-[#07090f] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-700/15 blur-[100px]" />
        <div className="absolute bottom-1/4 left-1/4 w-[300px] h-[300px] -translate-x-1/2 translate-y-1/2 rounded-full bg-indigo-700/15 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="rounded-2xl border border-white/10 bg-[#0d1117] shadow-2xl shadow-black/50 p-8">
          ...
          <p className="text-white/50 text-sm mb-6">Start practising interviews with AI</p>
