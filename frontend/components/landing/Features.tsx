    ...
    <section id="features" className="relative py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-indigo-400 text-sm font-semibold tracking-widest uppercase mb-3">Features</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f) => (
            <div key={f.title} className="group relative p-6 rounded-2xl border border-white/8 bg-white/3 hover:bg-white/5 hover:border-white/12 transition-all duration-300">
              {/* Icon */}
              <div className={`w-11 h-11 rounded-xl ${f.glow} flex items-center justify-center mb-4 text-white`}>
                <div className={`bg-gradient-to-br ${f.gradient} bg-clip-text`} style={{ color: 'transparent', display: 'flex' }}>
